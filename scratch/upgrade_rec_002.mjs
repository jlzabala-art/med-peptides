...
async function upgradeRec002() {
  const protocolId = 'rec_002';
  ...
  updatePayload.variant_rules = {
    age_variants: {
      ...
      "36-50": { default_duration_weeks: 8, monitoring_intensity: "moderate" },
      "51-65": { default_duration_weeks: 12, monitoring_intensity: "enhanced" },
      "65+": { default_duration_weeks: 12, monitoring_intensity: "enhanced" }
    },
    sex_variants: {
      female: { special_notes: ["Monitor for peripheral neural changes and tolerability."] },
  ...
  updatePayload.generator_rules = {
    selection_priority: ["goal_match", "age_variant_match", "neural_injury_match"],
...
upgradeRec002().catch(console.error);
