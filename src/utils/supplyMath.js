...
import { parseFrequencyToInjectionsPerWeek } from './dosageUtils.js';
 ...
 */
export const COMPOUND_VIAL_SIZES = {
  // ── Weight Management ──────────────────────────────────────────────────
 ...
 */
export function resolveVialSizeMg(drug) {
 ...
 */
export function suggestOptimalFrequency(slug, currentDosingPerWeek) {
 ...
 */
export function calculateVialsNeeded({ doseAmount, maxDose, dosingPerWeek, durationWeeks, vialSizeMg, canonicalVials = null, isWeeklyDose = false, slug = '' }) {
 ...
 */
export function derivePhaseSupply(phase_blueprints = [], dailyDose = null) {
 ...
 */
export function buildSupplyManifest(enrichedPhases) {
