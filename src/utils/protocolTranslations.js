...
export const PROTOCOL_I18N = {
  en: {
    ...
    catalogHeroSubtitle: 'Explore 77 therapeutic protocols formulated with Lotusland pharmaceutical grade catalog. Monotherapies and combined synergies with dosage schedules, titration phases, and safety biomarkers.',
    activeProtocolsKpi: 'Active Protocols',
    therapeuticGoalsKpi: 'Therapeutic Goals',
    ...
    monophasic: 'Single Phase (1)',
    progressiveTitration: 'Progressive Titration (2+)',
    sortBy: 'Sort by',
