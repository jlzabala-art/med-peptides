...
export default function QuotationSmartFilters({ onClose }) {
  return (
    <div style={{ 
      ...
      <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        {/* Search */}
        <div>
          <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, marginBottom: '0.5rem' }}>Search Customers</label>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', background: 'var(--bg-subtle)', padding: '0.5rem 0.75rem', borderRadius: '6px', border: '1px solid var(--border)' }}>
            ...
            <input type="text" placeholder="Clinic or Doctor name..." style={{ border: 'none', background: 'transparent', outline: 'none', width: '100%', fontSize: '0.85rem' }} />
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {['Draft', 'Pending Approval', 'Sent', 'Accepted'].map(status => (
        ...
        {/* Value Range */}
        <div>
          <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, marginBottom: '0.5rem' }}>Pipeline Value</label>
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            <input type="number" placeholder="Min $" style={{ width: '50%', padding: '0.5rem', borderRadius: '6px', border: '1px solid var(--border)' }} />
            <input type="number" placeholder="Max $" style={{ width: '50%', padding: '0.5rem', borderRadius: '6px', border: '1px solid var(--border)' }} />
          </div>
        </div>
