  ...
  return (
    <section style={{ padding: '2rem 1rem' }}>
      <div className="container" style={{
        background: 'linear-gradient(135deg, #020e1c 0%, #001f3f 100%)',
        borderRadius: '32px',
        ...
        {/* Decorative Elements */}
        <div style={{ position: 'absolute', top: '-10%', right: '-5%', width: '300px', height: '300px', background: 'radial-gradient(circle, rgba(0, 163, 224, 0.2) 0%, transparent 70%)', zIndex: 0 }} />
        <div style={{ position: 'absolute', bottom: '-20%', left: '10%', width: '400px', height: '400px', background: 'radial-gradient(circle, rgba(16, 185, 129, 0.1) 0%, transparent 70%)', zIndex: 0 }} />
        ...
        <div style={{ position: 'relative', zIndex: 1, flex: '1 1 500px' }}>
          ...
          <p style={{ color: '#cbd5e1', fontSize: '1.15rem', lineHeight: 1.6, marginBottom: '2.5rem', maxWidth: '550px' }}>
           ...
           <div style={{ 
             ...
             position: 'relative'
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                <div style={{ width: '90%', height: '10px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', marginBottom: '0.5rem' }} />
                <div style={{ width: '75%', height: '10px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px' }} />
              </div>
              
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '2rem' }}>
                 <div style={{ height: '60px', background: 'rgba(0,163,224,0.1)', borderRadius: '16px', border: '1px solid rgba(0,163,224,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ width: '50%', height: '8px', background: 'rgba(0,163,224,0.3)', borderRadius: '4px' }} />
                 </div>
                 <div style={{ height: '60px', background: 'rgba(255,255,255,0.02)', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ width: '50%', height: '8px', background: 'rgba(255,255,255,0.1)', borderRadius: '4px' }} />
                 </div>
              </div>

              <div style={{ height: '120px', background: 'linear-gradient(to bottom, rgba(255,255,255,0.03), transparent)', borderRadius: '16px', padding: '1.5rem' }}>
                 ...
                 <div style={{ spaceY: '0.5rem' }}>
                   ...
                   <div style={{ width: '85%', height: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '3px', marginBottom: '0.5rem' }} />
                   <div style={{ width: '60%', height: '6px', background: 'rgba(255,255,255,0.05)', borderRadius: '3px' }} />
                 </div>
              </div>
           </div>
        </div>
