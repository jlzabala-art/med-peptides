...
export default function SmartEmptyState({ message, hint, icon: Icon = Lightbulb }) {
  return (
    <div style={{
      ...
      textAlign: 'center', padding: '1.5rem 1rem', gap: '0.75rem',
      ...
      <p style={{
        ...
        margin: 0, lineHeight: 1.5, maxWidth: '240px',
        fontStyle: 'italic',
      }}>
        {message}
      </p>
      {hint && (
        <p style={{
          fontSize: '0.68rem', color: 'var(--text-light)', opacity: 0.6,
          margin: 0, lineHeight: 1.4, maxWidth: '220px',
        }}>
          {hint}
        </p>
      )}
