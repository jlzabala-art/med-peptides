import { Users, Repeat, Clock, Search, BrainCircuit, TrendingUp, TrendingDown } from '@/lib/icons';
...
function Tile({ icon: Icon, color, bg, label, value, trend, sub, wide }) {
  return (
    ...
    >
      ...
      {sub && (
        <span style={{ fontSize: '0.68rem', color: 'var(--text-light)', fontWeight: 500 }}>
          {sub}
        </span>
      )}
    </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div
                style={{ fontSize: '0.72rem', color: 'var(--text-light)', marginTop: '0.15rem' }}
              >
                {aiRate > 0
