...
import { FileText, UploadCloud, CheckCircle, Clock, AlertCircle, X, ExternalLink, Bot, Database } from 'lucide-react';
      ...
      async () => {
        try {
          ...
          await addDoc(collection(db, 'uploaded_documents'), {
            ...
            documentType: 'UNKNOWN', // 'COA', 'PRICING_LIST', etc.
    ...
    <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      >
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', maxWidth: '400px', margin: '0 auto 1.5rem' }}>
          Drag and drop PDF Certificates of Analysis (CoA) or Pricing Lists. The AI will automatically extract data and associate it with products.
        </p>
