    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 600, color: 'var(--color-text, #111)' }}>
              {title}
            </h2>
            {subtitle && (
              <div style={{ margin: '0.25rem 0 0 0', fontSize: '0.875rem', color: 'var(--color-text-tertiary, #666)' }}>
                {subtitle}
              </div>
            )}
          </div>
