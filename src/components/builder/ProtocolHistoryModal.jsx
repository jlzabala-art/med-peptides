      ...
      <div style={{
                       ...
                       <div style={{ display: 'flex', gap: '0.5rem', position: 'relative' }}>
                         ...
                         {activeMenu === p.id && (
                           ...
                           >
                             ...
                             {/* Safety Warning */}
                             <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'flex-start', padding: '0.6rem 1rem', borderTop: '1px solid var(--border)', background: '#fffbeb' }}>
                         ...
                         <button
                           ...
                           style={{ padding: '0.4rem', borderRadius: '8px', border: '1px solid #fee2e2', background: '#fef2f2', color: '#b91c1c', cursor: 'pointer', minHeight: '44px' }}
        ...
        <div style={{ padding: '1.25rem 2rem', borderTop: '1px solid var(--border)', backgroundColor: 'white', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
             ...
             <span style={{ fontSize: '0.75rem', fontWeight: 700, color: '#16a34a' }}>SECURE CLINICAL VAULT</span>
          </div>
        </div>
      </div>
    </div>
