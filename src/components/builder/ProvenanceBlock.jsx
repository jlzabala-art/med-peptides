    ...
    <div style={{
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
          {protocol_is_physician_authored && (
            <span style={{ backgroundColor: '#fef2f2', color: '#b91c1c', border: '1px solid #fecaca', padding: '4px 10px', borderRadius: '6px', fontSize: '0.7rem', fontWeight: 800, letterSpacing: '0.05em' }}>
              PHYSICIAN PROTOCOL
            </span>
          )}
          {protocol_is_curated && (
