...
export default function ValidationSummary({ validation, onFix, formData }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{
        background: issuesCount > 0 ? '#fff1f2' : '#f0fdf4',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          <div style={{ 
            padding: '12px', 
            borderRadius: '16px', 
            backgroundColor: issuesCount > 0 ? '#ef4444' : '#10b981',
            color: 'white'
           }}>
        ...
        <div style={{ display: 'flex', gap: '2rem' }}>
           <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '1.5rem', fontWeight: 900, color: issuesCount > 0 ? '#ef4444' : '#64748b' }}>{issuesCount}</div>
              <div style={{ fontSize: '0.65rem', fontWeight: 800, color: '#94a3b8' }}>ISSUES DETECTED</div>
           </div>
           <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '1.5rem', fontWeight: 900, color: '#10b981' }}>{passedCount}</div>
              <div style={{ fontSize: '0.65rem', fontWeight: 800, color: '#94a3b8' }}>CHECKS PASSED</div>
           </div>
        </div>
      </div>
        ...
        {(summary_badges || []).map((badge, idx) => {
          ...
          return (
            <div key={idx} style={{ 
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'flex-start' }}>
                  <div style={{ 
                    ...
                    padding: '8px', 
                    borderRadius: '10px', 
                    backgroundColor: badge.passed ? '#f0fdf4' : '#fff1f2' 
                  }}>
                    {badge.passed ? <CheckCircle2 size={18} color="#10b981" /> : <AlertTriangle size={18} color="#ef4444" />}
                  </div>
                  <div>
                ...
                <div style={{ 
                  color: badge.passed ? '#059669' : '#ef4444',
                  fontSize: '0.7rem',
                  fontWeight: 900,
              ...
              {/* WARNING BLOCK */}
              <div style={{ 
                backgroundColor: hasIssues ? '#fff1f2' : '#f8fafc',
                borderRadius: '12px',
                padding: '1.5rem',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#f8fafc' }}>
              ...
              <button onClick={() => setActivePopup(null)} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '8px', color: '#64748b' }}><X size={20} /></button>
            </div>
