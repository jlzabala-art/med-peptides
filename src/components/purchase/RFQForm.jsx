...
export default function RFQForm({ rfq, onClose }) {
  ...
  const [items, setItems] = useState(rfq?.items || [{ itemName: '', quantity: 1, unit: 'vial', expectedCost: 0 }]);
  ...
  const addItem = () => setItems([...items, { itemName: '', quantity: 1, unit: 'vial', expectedCost: 0 }]);
