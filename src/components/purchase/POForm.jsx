...
import { savePurchaseOrder } from '../../services/procurementService';
import { Card } from '../ui';
import DataTable from '../ui/DataTable';
import ProductAutocomplete from '../shared/ProductAutocomplete';
import AppActionGroup from '../ui/AppActionGroup';
import { X, Send, Plus, Trash2, CheckCircle, Save, Package } from '@/lib/icons';
...
export default function POForm({ po, onClose }) {
  ...
  const handleSave = async () => {
    ...
    try {
      await savePurchaseOrder(poData, po?.id || null);
      onClose();
    } catch (error) {
