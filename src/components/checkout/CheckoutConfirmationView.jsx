 ...
 * Post-submission Order & Protocol Activation confirmation screen.
 */
    ...
    <>
      ...
      >
        ...
        <div className="pa-content-grid">
          {/* LEFT COLUMN: Payment Instructions & Steps */}
          <div className="pa-col-left">
                ...
                <div>
                  ...
                  >
                    ...
                    <span>
                      ...
                      <strong style={{ color: 'var(--primary)' }}>{formData.email}</strong>. Use{' '}
                      <strong>Order {orderId}</strong> as the payment reference.
                    </span>
                  </div>
                  <div
                    style={{
                ...
                <div>
                  ...
                  >
                    ...
                    <span>
                      ...
                      <strong style={{ color: '#6366f1' }}>{formData.email}</strong> within the next{' '}
                      <strong>48 hours</strong>. Open it to pay safely via credit or debit card.
                    </span>
                  </div>
            ...
            <div className="pa-section" style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.borderColor = 'rgba(0,113,189,0.5)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = 'transparent';
                  e.currentTarget.style.borderColor = 'rgba(0,113,189,0.3)';
                }}
              >
            ...
            >
              <p style={{ fontSize: '0.82rem', color: 'var(--color-text-primary)', lineHeight: 1.7, margin: '0 0 1rem' }}>
              ...
              >
                ...
                <div style={{ padding: '0.85rem 1.25rem', display: 'flex', flexDirection: 'column', gap: '0.55rem' }}>
                  {suppliesItems.map((i) => (
                    ...
                    >
                      <span style={{ fontFamily: 'monospace', fontSize: '0.85rem', color: '#0f172a' }}>
                        {i.namePart}
                        {i.dosagePart ? ` — ${i.dosagePart}` : ''}
                      </span>
                      <span style={{ fontFamily: 'monospace', fontSize: '0.78rem', color: 'var(--color-text-tertiary)' }}>
                        {i.qty} unit{i.qty > 1 ? 's' : ''}
                      </span>
                    </div>
                  ))}
