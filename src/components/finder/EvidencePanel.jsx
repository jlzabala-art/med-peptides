...
export default function EvidencePanel({ evidence }) {
  ...
  if (!evidence || Object.keys(evidence).length === 0) {
    return (
      <div style={{ padding: '1.5rem', backgroundColor: 'var(--color-bg-app)', borderRadius: '16px', border: '1px solid #e2e8f0', textAlign: 'center' }}>
        <AlertCircle size={32} color="var(--color-text-tertiary)" style={{ marginBottom: '1rem' }} />
        <h4 style={{ color: 'var(--color-text-secondary)', marginBottom: '0.5rem' }}>Limited Direct Literature Found</h4>
