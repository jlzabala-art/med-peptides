  ...
  const renderKPIs = () => (
    ...
    >
      <div
        style={{
          ...styles.kpiCard,
          border: activeFilter === 'Prescription' ? '2px solid #0284c7' : styles.kpiCard.border,
        }}
        onClick={() => setActiveFilter(activeFilter === 'Prescription' ? null : 'Prescription')}
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <div style={{ ...styles.kpiIconBox, background: '#e0f2fe', color: '#0284c7' }}>
            <Pill size={20} />
          </div>
          <div>
      ...
      <div
        style={{
          ...styles.kpiCard,
          border: activeFilter === 'Follow-Up' ? '2px solid #d97706' : styles.kpiCard.border,
        }}
        onClick={() => setActiveFilter(activeFilter === 'Follow-Up' ? null : 'Follow-Up')}
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
      ...
      <div
        style={{
          ...styles.kpiCard,
          border: activeFilter === 'Genetic Test' ? '2px solid #db2777' : styles.kpiCard.border,
        }}
        onClick={() => setActiveFilter(activeFilter === 'Genetic Test' ? null : 'Genetic Test')}
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <div style={{ ...styles.kpiIconBox, background: '#fce7f3', color: '#db2777' }}>
            <Activity size={20} />
          </div>
          <div>
      ...
      <div
        style={{
          ...styles.kpiCard,
          border: activeFilter === 'Consultation' ? '2px solid #059669' : styles.kpiCard.border,
        }}
        onClick={() => setActiveFilter(activeFilter === 'Consultation' ? null : 'Consultation')}
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <div style={{ ...styles.kpiIconBox, background: '#d1fae5', color: '#059669' }}>
            <Users size={20} />
          </div>
          <div>
      ...
      <div style={{ ...styles.cardHeader, display: 'flex', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', gap: '4px' }}>
            ...
            <button style={styles.iconBtn} onClick={() => setCurrentDate(new Date())}>
              Today
            </button>
            <button
              style={styles.iconBtn}
      ...
      <div style={{ padding: '16px', overflowX: 'auto' }}>
        {viewMode === 'Agenda' ? (
              ...
              >
                <div>
                  ...
                  <div style={{ color: '#64748b', fontSize: '12px', marginTop: '4px' }}>
                    {ev.date.toLocaleDateString()} • {ev.type}
                  </div>
                </div>
                <div
                  style={{
          ...
          <div
            style={{
              display: 'grid',
              gridTemplateColumns: viewMode === 'Day' ? '80px 1fr' : '80px repeat(5, 1fr)',
              gap: '8px',
              minWidth: viewMode === 'Day' ? 'auto' : '600px',
            }}
          >
            {/* Time Column */}
            <div
              ...
              >
                <div
                  style={{
                    fontSize: '13px',
                    fontWeight: 600,
                    color: viewMode === 'Day' || idx === 2 ? '#0ea5e9' : '#475569',
                    marginBottom: '16px',
                    textAlign: 'center',
                  }}
                >
  ...
  const renderRightPanel = () => (
    <div
      style={{
        ...
        flexDirection: 'column',
        gap: '24px',
        flex: isMobile ? 'none' : '0 0 calc(35% - 24px)',
      }}
    >
    ...
    <div style={styles.container}>
      <AdminPageHeader
        ...
        actions={
          !isMobile && (
            <>
              <button className="secondary-btn" onClick={() => toast.success('New Prescription')}>
                <Pill size={16} /> Prescription
              </button>
              <button className="primary-btn" onClick={() => toast.success('New Appointment')}>
