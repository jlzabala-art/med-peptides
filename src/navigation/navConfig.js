...
export const CATALOG_BROWSE = [
  {
    label: 'Browse All Catalog',
    path: '/collection/all',
    icon: 'LayoutGrid',
    desc: 'Full product & protocol catalog',
  },
  {
  ...
  },
  {
    ...
    icon: 'FlaskConical',
    desc: 'Individual peptides & supplements',
  },
  {
...
export const ACADEMIA_MENU = [
  {
    ...
    icon: 'FlaskConical',
    desc: 'Science & classification of peptide compounds',
  },
  {
    label: 'What Are Protocols',
    path: '/what-are-protocols',
    icon: 'ClipboardList',
    desc: 'How clinical peptide protocols are structured',
  },
  {
    label: 'Science Blog',
    path: '/blog',
    icon: 'BookOpen',
    desc: 'Latest research, updates & peptide literature',
  },
  {
    label: 'Dose Calculator',
    path: '/calculator',
    icon: 'Calculator',
    desc: 'Compute precise dosage & reconstitution',
  },
  {
    label: 'Reconstitution Guides',
    path: '/reconstitution-guide',
    icon: 'Beaker',
    desc: 'Step-by-step mixing protocols',
  },
...
export const RESOURCES_MENU = [
  ...
  { label: 'Contact', path: '/contact', icon: 'Mail', desc: 'Reach our clinical support team' },
  {
    ...
    path: '/legal',
    icon: 'Scale',
    desc: 'Regulatory and compliance notices',
  },
  {
  ...
  },
  {
    ...
    path: '/terms',
    icon: 'FileText',
    desc: 'Terms governing use of this platform',
  },
];
...
export const USER_MENU = {
  ...
  admin: [
    ...
    },
    {
      ...
      path: '/admin?s=architecture&t=ai-agents',
      icon: 'Bot',
      section: 'admin',
      domain: 'Architecture',
    },
