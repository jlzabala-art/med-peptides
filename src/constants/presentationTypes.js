...
export const PRESENTATION_LABELS = {
  ...
  iv_drip:              'IV Drip (50 mL)',
  infusion_bag:         'IV Infusion Bag',
  capsule:              'Capsule',
  tablet:               'Tablet',
...
export const PRESENTATION_ALIASES = {
  ...
  'iv_drip':                   'iv_drip',
  'iv drip':                   'iv_drip',
  'iv drip (50ml)':            'iv_drip',
  'iv drip (50 ml)':           'iv_drip',
  'iv':                        'iv_drip',
  'drip':                      'iv_drip',
  'iv infusion':               'iv_drip',
  'infusion':                  'iv_drip',
  'infusion bag':              'infusion_bag',
  'iv bag':                    'infusion_bag',
  '50ml iv drip':              'iv_drip',
