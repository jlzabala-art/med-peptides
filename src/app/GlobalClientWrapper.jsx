...
const PORTAL_PREFIXES = ['/admin', '/doctor', '/patient', '/clinic', '/supplier', '/wholesaler', '/pharmacy', '/login', '/session-ended', '/shared', '/quotation', '/p', '/proto', '/catalog', '/verify', '/c', '/mediluxe', '/company'];
