...
if (index === -1) {
  console.log('could not find return of ManagerDetailPanel');
  process.exit(1);
}

const endFunctionStr = "  );\n}";
const endIndex = content.lastIndexOf(endFunctionStr) + endFunctionStr.length;
...
content = content.substring(0, index) + newPanel;
